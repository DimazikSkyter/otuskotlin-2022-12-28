...
import ru.escalop.exceptions.UnknownRequestClass
...
fun getDocumentType(documentType: ru.escalop.api.v1.models.DocumentType): DocumentType {
    return when(documentType) {
        ru.escalop.api.v1.models.DocumentType.GENERAL -> DocumentType.BLOOD_GENERAL
        ru.escalop.api.v1.models.DocumentType.CHEMISTRY -> DocumentType.BLOOD_CHEMISTRY
    }
}
