...
import ru.escalop.api.v1.models.DocumentUploadResponse
import ru.escalop.api.v1.models.SnapshotReadResponse
import ru.escalop.api.v1.models.SnapshotSearchResponse
...
class MapperTest {
    ...
    fun uploadFromTransport() {
        ...
        val req = DocumentUploadRequest(
            ...
            uploadMetaData = DocumentUploadObject(documentName, ru.escalop.api.v1.models.DocumentType.CHEMISTRY, file)
        )
    ...
    fun readToTransport() {
        ...
        val context = EscalopContext (
            ...
            response = ru.escalop.common.model.SnapshotReadResponse(
                snapshotId,
                snapshotData
            )
        )
    ...
    fun searchToTransport() {
        ...
        val context = EscalopContext (
            ...
            response = ru.escalop.common.model.SnapshotSearchResponse(
        ...
        assertContains(req.list!!, SnapshotListObject(BigDecimal(333),  ru.escalop.api.v1.models.DocumentType.GENERAL, date, docName1))
        assertContains(req.list!!, SnapshotListObject(BigDecimal(334),  ru.escalop.api.v1.models.DocumentType.GENERAL, date, docName2))
    }
}