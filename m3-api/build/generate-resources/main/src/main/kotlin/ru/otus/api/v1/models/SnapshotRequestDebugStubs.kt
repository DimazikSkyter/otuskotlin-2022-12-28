...
enum class SnapshotRequestDebugStubs(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is SnapshotRequestDebugStubs) "$data" else null

        /**
         * Returns a valid [SnapshotRequestDebugStubs] for [data], null otherwise.
         */
        fun decode(data: kotlin.Any?): SnapshotRequestDebugStubs? = data?.let {
